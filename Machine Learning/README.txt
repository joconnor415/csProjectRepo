1) If you were given the HTML contents of a single web page, how would you determine the 10 words that best capture the meaning/content of the text on the page? How would your approach change if the page were written in a foreign language that you couldn't understand?
     ...
     For my implementation (evernote_ML_questions.py) of this question, I decided to use the “Bag of Words” model to represent the contents of the web page and the different corpus'. I used the ML/Text Processing libraries NLTK for text analysis, and LangID for language detection.
...
python evernote_ML_questions.py 
